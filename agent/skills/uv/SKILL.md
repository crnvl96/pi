...
name: uv
description: |
  uv integration focused on Python project and standalone script management.
  Use `uv` instead of pip/python/venv.
  Run scripts with `uv run script.py`, add deps with `uv add`, use inline script metadata for standalone scripts."
---
